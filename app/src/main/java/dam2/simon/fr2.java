        ...
        afegir2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(cont2 == 0){
                    ...
                    ajuda2.setText("En caso que falles, habrá terminado la partida, y se registrará tu puntuación");
                    cont2=2;
                }else{
                    afegir2.setText("Siguiente");
                    imageHelp2.setImageResource(R.drawable.img1);
                    ajuda2.setText("Una vez estas en la pantalla de inicio, para empezar a jugar tienes que hacer clic sobre play");
                    cont2=0;
                }
            }
        });
